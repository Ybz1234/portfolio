  ...
  return (
    <div id='Databases' className='p-20 flex flex-col items-center justify-center'>
      ...
      <div className='grid lg:grid-cols-3 mf:grid-cols-1 justify-around gap-20'>
        ...
        <img data-aos="fade-up" className='text-[26px] flex items-center justify-center rounded-ss-3xl rounded-br-3xl h-36 w-44 p-1 border-2 border-fuchsia-800 b_glow' src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/firebase/firebase-original-wordmark.svg" alt="Firebase" srcset="" />
      </div>
    </div>
  )
}
